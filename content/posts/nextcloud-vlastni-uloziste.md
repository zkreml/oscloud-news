...
author: "Oscloud"
cover:
  image: images/baner_nextcloud.png
  alt: "Nextcloud na OSCloud"
---
...
Na [oscloud.cz](https://oscloud.cz) provozujeme Nextcloud jako komunitní službu.
Žádné korporace, žádné monetizování dat. Servery stojí u Hetzner ve Falkensteinově — EU, GDPR, bez amerického CLOUD Actu.
...
Pro ty, kdo potřebují opravdu víc, připojíme vlastní dedikované úložiště — fyzicky oddělené, přístup má jen tvůj účet.
Po aktivaci se ti v Nextcloudu objeví složka `/data` jako externí úložiště, kterou používáš stejně jako všechno ostatní.
...
Každé dedikované úložiště má automatické snapshoty — 6 denních záloh zdarma.
Snapshot nezabere místo hned, sdílí kapacitu s úložištěm a roste jen podle toho, co se změnilo nebo smazalo.
...
Ozvi se přes [helpdesk](https://helpdesk.oscloud.cz/help/3020290644) nebo na Mastodonu [@oscloud@mamutovo.cz](https://mamutovo.cz/@oscloud). Domluvíme se.
